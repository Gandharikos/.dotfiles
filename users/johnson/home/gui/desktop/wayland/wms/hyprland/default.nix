...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    wayland.windowManager.hyprland = {
      ...
      # UWSM owns the graphical session lifecycle and environment import.
      systemd.enable = false;
      extraConfig = builtins.readFile (relativeToConfig "hypr/hyprland.lua");
      extraLuaFiles = {
        generated = ''
          -- Generated by Home Manager. Edit config/hypr/hyprland.lua for static config.
          return ${toLua { } generated}
        '';
        "hypr.appearance" = relativeToConfig "hypr/hypr/appearance.lua";
        "hypr.binds" = relativeToConfig "hypr/hypr/binds.lua";
        "hypr.core" = relativeToConfig "hypr/hypr/core.lua";
        "hypr.input" = relativeToConfig "hypr/hypr/input.lua";
        "hypr.lib" = relativeToConfig "hypr/hypr/lib.lua";
        "hypr.rules" = relativeToConfig "hypr/hypr/rules.lua";
        "hypr.startup" = relativeToConfig "hypr/hypr/startup.lua";
        "plugins.dynamic-cursors" = relativeToConfig "hypr/plugins/dynamic-cursors.lua";
      };
    };
  };
}
